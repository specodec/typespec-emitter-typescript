...
describe('generation + compile', () => {
  ...
  it('tsp generates ~200 codec files', () => {
    ...
    execSync(`${TSP} compile alltypes.tsp --emit=@specodec/typespec-emitter-typescript --option @specodec/typespec-emitter-typescript.emitter-output-dir=generated`, { cwd: TDIR, stdio: 'pipe' });
